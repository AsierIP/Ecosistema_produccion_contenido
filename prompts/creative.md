...
Prepara un plan visual realizable, con acciones que expresen el guion y variedad semántica entre segmentos. Usa referencias y personajes aprobados cuando el perfil los exija. Estima el encaje de voz antes de solicitar medios; la duración real se medirá después, sin acelerar habla ni añadir silencio para rellenar.
